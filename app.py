...
def main():
    ...
    ''')  
    st.write('''Upcoming Festures! - OCR Integration, History of Asked Questions, Summarizer, Download PDF, Chat-like Interface, Multilingual Support.
    ''')
